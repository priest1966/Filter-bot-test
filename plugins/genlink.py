...
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("Use correct format.\nExample <code>/batch https://t.me/movieverse_discussion_2/10 https://t.me/movieverse_discussion_2/20</code>.")
    ...
    post = await bot.send_document(LOG_CHANNEL, f"batchmode_{message.from_user.id}.json", file_name="Batch.json", caption="Generated for filestore.")
