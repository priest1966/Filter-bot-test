...
# Bot information
SESSION = environ.get('SESSION', 'Filter')
API_ID = int(environ.get('API_ID', '900652'))
API_HASH = environ.get('API_HASH', 'a4183efcd370bf03011df1ba8772b1c9')
BOT_TOKEN = environ.get('BOT_TOKEN', "6918704696:AAG-PAOljpmdQjwUbb3KzGMUEUhbNJFZnYA")
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rudrakshmeena:ObFdR2gZFXNdqfEQ@cluster0.ct29vrs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
REFERAL_PREMEIUM_TIME = environ.get('REFERAL_PREMEIUM_TIME', '15day')
